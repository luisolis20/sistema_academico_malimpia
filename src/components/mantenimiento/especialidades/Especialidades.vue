    ...
    <div class="container-fluid py-4">
                    ...
                    <div class="modal-body p-4">
                        ...
                        <div class="alert alert-success bg-success-subtle border-0 d-flex align-items-center p-3 mb-4 rounded-3"
                            ...
                            <div class="small text-dark">
                                ...
                                Registra una especialidad (ej. <em>"Básica" (para escuela)</em>, <em>Informática </em>, <em>Contabilidad</em>)
                        ...
                        <form @submit.prevent="guardarData">
                            <div class="mb-3">
                                ...
                                <div class="form-text text-muted small ms-1">Debe ser un nombre corto y descriptivo. Ej: Básica, Informática, Contabilidad...</div>
                            </div>
        ...
        <div class="modal fade" id="modalEditUsuario" tabindex="-1" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
                <div class="modal-content border-0 shadow-lg" style="border-radius: 20px;">
                    <div class="modal-header border-0 bg-light rounded-top-4">
                        <h5 class="modal-title fw-bold text-primary"><i class="fas fa-edit me-2"></i>Editar Especialidad</h5>
