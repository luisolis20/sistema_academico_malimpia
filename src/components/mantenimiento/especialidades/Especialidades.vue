    ...
    <div class="container-fluid py-4">
        <header class="bg-white p-4 rounded-4 shadow-sm mb-4 custom-header" style="border-left: 6px solid #F4B324;">
            ...
            <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center w-100">
                ...
                <div class="mb-3 mb-md-0 d-flex align-items-center">
                    <div class="header-icon shadow-sm rounded-circle d-flex justify-content-center align-items-center me-3"
                        ...
                        <i class="fas fa-graduation-cap fs-4" style="color: #F4B324;"></i>
                    </div>
                    <div>
                ...
                <div class="d-flex align-items-center gap-3">
                    <div class="stat-badge d-flex align-items-center px-3 py-2 rounded-pill border shadow-sm"
                        ...
                        <i class="fas fa-award me-2" style="color: #F4B324;"></i>
                        <span class="fw-bold">
            ...
            <div class="mt-3 p-3 rounded-3 d-flex align-items-start gap-3"
                ...
                <i class="fas fa-certificate fs-5 mt-1" style="color: #F4B324;"></i>
                <p class="mb-0 text-secondary" style="font-size: 0.88rem; line-height: 1.45;">
                    <strong>Diversificación y Perfiles Formativos:</strong> En esta sección se parametrizan las
                    menciones institucionales y figuras profesionales (tales como tronco común de <em>Educación
                        Básica</em>, o bachilleratos técnicos en <em>Informática</em> y <em>Contabilidad</em>). Su
                    correcto registro es clave para la diversificación del mapa de estudio, ya que permite al sistema
                    segregar, filtrar y asignar de forma automatizada la carga horaria y las asignaturas específicas a
                    cada estudiante según su especialidad elegida, blindando la emisión de expedientes y actas de grado.
                </p>
            </div>
                            ...
                            <td class="text-center">
                                <div class="btn-group">
                                    <button class="btn btn-sm btn-light border shadow-sm" style="color: #1D2A68;"
                                        ...
                                        @click="cargarDatosEdicion(user)" title="Editar detalles de esta especialidad">
                ...
                <div class="modal-content border-0 shadow-lg" style="border-radius: 20px;">
                    <div class="modal-header border-0 bg-light rounded-top-4">
                        <h5 class="modal-title fw-bold" style="color: #1D2A68;">
                            <i class="fas fa-plus-circle me-2" style="color: #F4B324;"></i>Registrar nueva Especialidad
                        </h5>
                    ...
                    <div class="modal-body p-4">
                        ...
                        <form @submit.prevent="guardarData">
                            ...
                            <button type="submit" class="btn w-100 py-2 shadow-sm rounded-3 fw-bold border-0"
                                style="background-color: #1D2A68; color: white;">
                                <i class="fas fa-save me-2" style="color: #F4B324;"></i>Crear Especialidad
                            </button>
                        </form>
                    </div>
                </div>
        ...
        <div class="modal fade" id="modalEditUsuario" tabindex="-1" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
                <div class="modal-content border-0 shadow-lg" style="border-radius: 20px;">
                    <div class="modal-header border-0 bg-light rounded-top-4">
                        <h5 class="modal-title fw-bold" style="color: #1D2A68;">
                            <i class="fas fa-edit me-2" style="color: #F4B324;"></i>Editar Especialidad
                        </h5>
